...
<form method='post' action='ope.php' id='formlogin' name='formlogin' > <fieldset id='fie'> 
<legend>Autenticação</legend><br />
<center>
<div >
<input type='text' name='login' id='login' placeholder='Usuário' /><br /><input type='password' name='senha' id='senha' placeholder='Senha' /><br /> <input class='btn btn-primary'type='submit' value='ENTRAR' /> </fieldset> </form>
</div>
</center>
</br>
</br>
